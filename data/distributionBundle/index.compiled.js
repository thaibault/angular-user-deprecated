...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("@angular/core"), require("angular-generic"), require("angular-generic/aheadOfTime.compiled/animation"), require("clientnode"), require("@angular/common"), require("@angular/forms"), require("@angular/material"), require("@angular/platform-browser"), require("@angular/router"), require("pouchdb-authentication/dist/pouchdb.authentication.min.js"), require("rxjs/Observable"), require("rxjs/add/observable/fromPromise"));
	else if(typeof define === 'function' && define.amd)
		define("angular-user", ["@angular/core", "angular-generic", "angular-generic/aheadOfTime.compiled/animation", "clientnode", "@angular/common", "@angular/forms", "@angular/material", "@angular/platform-browser", "@angular/router", "pouchdb-authentication/dist/pouchdb.authentication.min.js", "rxjs/Observable", "rxjs/add/observable/fromPromise"], factory);
	else if(typeof exports === 'object')
		exports["angular-user"] = factory(require("@angular/core"), require("angular-generic"), require("angular-generic/aheadOfTime.compiled/animation"), require("clientnode"), require("@angular/common"), require("@angular/forms"), require("@angular/material"), require("@angular/platform-browser"), require("@angular/router"), require("pouchdb-authentication/dist/pouchdb.authentication.min.js"), require("rxjs/Observable"), require("rxjs/add/observable/fromPromise"));
	else
		root['angularUser'] = factory(root["@angular/core"], root["angular-generic"], root["angular-generic/aheadOfTime.compiled/animation"], root["clientnode"], root["@angular/common"], root["@angular/forms"], root["@angular/material"], root["@angular/platform-browser"], root["@angular/router"], root["pouchdb-authentication/dist/pouchdb.authentication.min.js"], root["rxjs/Observable"], root["rxjs/add/observable/fromPromise"]);
 ...
 */var AuthenticationGuard/* implements CanActivate, CanActivateChild*/=exports.AuthenticationGuard=(_dec2=(0,_core.Injectable)(),_dec2(_class3=(_temp2=_class4=function(){/**
     ...
     * valid.
     * @returns A promise with an indicating boolean inside.
     */},{key:'checkLogin',value:function(){var _ref5=_asyncToGenerator(/*#__PURE__*/regeneratorRuntime.mark(function _callee5(){var _this3=this;var url=arguments.length>0&&arguments[0]!==undefined?arguments[0]:null;var autoRoute=arguments.length>1&&arguments[1]!==undefined?arguments[1]:true;return regeneratorRuntime.wrap(function _callee5$(_context5){while(1){switch(_context5.prev=_context5.next){case 0:_context5.next=2;return this.authentication.checkLogin(function(error,result){_this3.router.navigate([AuthenticationGuard.loginPath]);return result});case 2:if(!_context5.sent){_context5.next=4;break}return _context5.abrupt('return',true);case 4:if(url)this.authentication.lastRequestedURL=url;if(autoRoute)this.router.navigate([AuthenticationGuard.loginPath]);return _context5.abrupt('return',false);case 7:case'end':return _context5.stop();}}},_callee5,this)}));function checkLogin(){return _ref5.apply(this,arguments)}return checkLogin}()}]);return AuthenticationGuard}(),_class4.loginPath='/login',_temp2))||_class3);// endregion
// region components
// IgnoreTypeCheck
 ...
 */var LoginComponent=exports.LoginComponent=(_dec3=(0,_core.Component)({animations:[_animation.defaultAnimation],changeDetection:_core.ChangeDetectionStrategy.OnPush,host:{'[@defaultAnimation]':'','(window:keydown)':'$event.keyCode === keyCode.ENTER ? login() : null'},selector:'login',template:'\n        <div class="message" @defaultAnimation *ngIf="errorMessage">\n            {{errorMessage}}\n        </div>\n        <mat-form-field>\n            <input matInput [(ngModel)]="loginName" [placeholder]="loginLabel">\n            <mat-icon matSuffix>account_circle</mat-icon>\n        </mat-form-field>\n        <mat-form-field>\n            <input\n                matInput\n                [(ngModel)]="password"\n                [placeholder]="passwordLabel"\n                type="password"\n            >\n            <mat-icon matSuffix>lock</mat-icon>\n        </mat-form-field>\n        <button\n            (click)="login()"\n            @defaultAnimation\n            mat-raised-button\n            *ngIf="loginName && password"\n        >{{loginButtonLabel}}</button>\n    '}),_dec4=(0,_core.Input)(),_dec5=(0,_core.Input)(),_dec6=(0,_core.Input)(),_dec3(_class5=(_class6=function(){/**
     ...
     * @returns Nothing.
     */function LoginComponent(authentication,authenticationGuard,data,platformID,router,representObjectPipe,utility){var _this4=this;_classCallCheck(this,LoginComponent);this.errorMessage='';this.keyCode=this.keyCode;this.loginName='';_initDefineProp(this,'loginButtonLabel',_descriptor,this);_initDefineProp(this,'loginLabel',_descriptor2,this);this.password='';_initDefineProp(this,'passwordLabel',_descriptor3,this);this._authentication=this._authentication;this._authenticationGuard=this._authenticationGuard;this._data=this._data;this._representObject=this._representObject;this._router=this._router;this.keyCode=utility.fixed.tools.keyCode;this._authentication=authentication;this._authenticationGuard=authenticationGuard;// NOTE: Allow to pre-render the login page.
...
// region module
// IgnoreTypeCheck
(0,_core.Inject)(_core.PLATFORM_ID)(LoginComponent,null,3);Reflect.defineMetadata('design:paramtypes',[AuthenticationService,AuthenticationGuard,_angularGeneric.DataService,String,_router.Router,_angularGeneric.RepresentObjectPipe,_angularGeneric.UtilityService],LoginComponent);/**
 * Bundles user specific stuff into an importable angular module.
 */var Module=(_dec7=(0,_core.NgModule)({/*
    ...
    */exports:[LoginComponent],imports:[_platformBrowser.BrowserModule.withServerTransition({appId:'generic-universal'}),_forms.FormsModule,_angularGeneric2.default,_material.MatButtonModule,_material.MatIconModule,_material.MatInputModule],/*
        NOTE: Running "angularGeneric.moduleHelper.determineProviders()" is not
        yet supported by the AOT-Compiler.
    */providers:[AuthenticationGuard,AuthenticationService]}),_dec7(_class8=function Module(){_classCallCheck(this,Module)})||_class8);// endregion
// region vim modline
